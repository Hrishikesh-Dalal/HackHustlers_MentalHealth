...
class _SleepTrackerPageState extends State<SleepTrackerPage> {
  ...
  void saveSleepData() async {
    ...
    _selectedSleepType = '';
    _selectedSleepEnvironment = '';
    _sleepScore = null; // Reset sleep score
  }
  ...
  void generateSleepScore() {
    ...
    if (_selectedSleepType == 'Deep Sleep') {
      score += 20; // Example points for deep sleep
    ...
    if (_selectedSleepEnvironment == 'Bedroom') {
      score += 30; // Example points for bedroom sleep environment
    } else if (_selectedSleepEnvironment == 'Living Room') {
      score += 15; // Example points for living room sleep environment
